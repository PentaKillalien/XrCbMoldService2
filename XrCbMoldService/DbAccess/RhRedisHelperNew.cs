...
*
* 功 能： N/A
* 类 名：RhRedisHelperNew.cs
*
* Ver  变更日期 负责人 变更内容
* ───────────────────────────────────
* V0.01 2021/2/26 9:29:57  彭政亮 初版
*
...
namespace XrCbMoldService.DbAccess
{
    public class RhRedisHelperNew
    {
        ...
        public RhRedisHelperNew(int dbNum = 0)
            : this(dbNum, null)
        {
        }

        public RhRedisHelperNew(int dbNum, string readWriteHosts)
        {
            DbNum = dbNum;
            _conn = string.IsNullOrWhiteSpace(readWriteHosts) ?
                    RhRedisConnectionHelper.Instance :
                    RhRedisConnectionHelper.GetConnectionMultiplexer(readWriteHosts);
        }
        ...
        {
            var prefixKey = CustomKey ?? RhRedisConnectionHelper.SysCustomKey;
